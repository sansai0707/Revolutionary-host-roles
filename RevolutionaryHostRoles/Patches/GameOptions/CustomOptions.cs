...
namespace RevolutionaryHostRoles
{
    ...
    public class CustomOption
    {
        ...
        public CustomOption(int id, CustomOptionType type, string name, System.Object[] selections, System.Object defaultValue, CustomOption parent, bool isHeader)
        {
            ...
            if (id != 0)
            {
                entry = RevolutionaryHostRolesPlugin.Instance.Config.Bind($"プリセット {preset}", id.ToString(), defaultSelection);
        ...
        public static void switchPreset(int newPreset)
        {
            ...
            foreach (CustomOption option in CustomOption.options)
            {
                ...
                option.entry = RevolutionaryHostRolesPlugin.Instance.Config.Bind($"プリセット {preset}", option.id.ToString(), option.defaultSelection);
    ...
    class GameOptionsMenuStartPatch
    {
        public static void Postfix(GameOptionsMenu __instance)
        {
            ...
            var RHRSettings = UnityEngine.Object.Instantiate(gameSettings, gameSettings.transform.parent);
            var RHRMenu = RHRSettings.transform.FindChild("GameGroup").FindChild("SliderInner").GetComponent<GameOptionsMenu>();
            RHRSettings.name = "RHRSettings";
            ...
            var RHRTab = UnityEngine.Object.Instantiate(roleTab, roleTab.transform.parent);
            var RHRTabHighlight = RHRTab.transform.FindChild("Hat Button").FindChild("Tab Background").GetComponent<SpriteRenderer>();
            RHRTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.LoadSpriteFromResources("RevolutionaryHostRoles.Resources.RHRTabIcon.png", 100f);

            var crewmateTab = UnityEngine.Object.Instantiate(roleTab, RHRTab.transform);
            var crewmateTabHighlight = crewmateTab.transform.FindChild("Hat Button").FindChild("Tab Background").GetComponent<SpriteRenderer>();
            crewmateTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.LoadSpriteFromResources("RevolutionaryHostRoles.Resources.RHRTabIconCrewmate.png", 100f);
            ...
            impostorTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.LoadSpriteFromResources("RevolutionaryHostRoles.Resources.RHRTabIconImpostor.png", 100f);
            ...
            neutralTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.LoadSpriteFromResources("RevolutionaryHostRoles.Resources.RHRTabIconNeutral.png", 100f);
            ...
            RHRTab.transform.position += Vector3.left * 2f;
            ...
            var tabs = new GameObject[] { gameTab, roleTab, RHRTab, crewmateTab, impostorTab, neutralTab};
            for (int i = 0; i < tabs.Length; i++)
            {
                ...
                button.OnClick.AddListener((System.Action)(() => {
                    ...
                    RHRSettings.gameObject.SetActive(false);
                    ...
                    {
                        RHRSettings.gameObject.SetActive(true);
                        RHRTabHighlight.enabled = true;
                    }
            ...
            foreach (OptionBehaviour option in RHRMenu.GetComponentsInChildren<OptionBehaviour>())
                UnityEngine.Object.Destroy(option.gameObject);
            List<OptionBehaviour> RHROptions = new List<OptionBehaviour>();
            ...
            List<Transform> menus = new List<Transform>() { RHRMenu.transform, impostorMenu.transform, neutralMenu.transform, crewmateMenu.transform};
            List<List<OptionBehaviour>> optionBehaviours = new List<List<OptionBehaviour>>() { RHROptions, impostorOptions, neutralOptions, crewmateOptions };
            ...
            RHRMenu.Children = RHROptions.ToArray();
            RHRSettings.gameObject.SetActive(false);
    ...
    class GameOptionsMenuUpdatePatch
    {
        ...
        public static void Postfix(GameOptionsMenu __instance)
        {
            ...
            foreach (CustomOption option in CustomOption.options)
            {
                if (GameObject.Find("RHRSettings") && option.type != CustomOption.CustomOptionType.General)
                    continue;
    ...
    class GameOptionsDataPatch
    {
        ...
        {
            int counter = RevolutionaryHostRolesPlugin.optionsPage;
            string hudString = "";
    ...
    public static class GameOptionsNextPagePatch
    {
        ...
        {
            int page = RevolutionaryHostRolesPlugin.optionsPage;
            if (Input.GetKeyDown(KeyCode.Tab))
            {
                RevolutionaryHostRolesPlugin.optionsPage = (RevolutionaryHostRolesPlugin.optionsPage + 1) % 6;
            }
            if (Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Keypad1))
            {
                RevolutionaryHostRolesPlugin.optionsPage = 0;
            }
            if (Input.GetKeyDown(KeyCode.Alpha2) || Input.GetKeyDown(KeyCode.Keypad2))
            {
                RevolutionaryHostRolesPlugin.optionsPage = 1;
            }
            if (Input.GetKeyDown(KeyCode.Alpha3) || Input.GetKeyDown(KeyCode.Keypad3))
            {
                RevolutionaryHostRolesPlugin.optionsPage = 2;
            }
            if (Input.GetKeyDown(KeyCode.Alpha4) || Input.GetKeyDown(KeyCode.Keypad4))
            {
                RevolutionaryHostRolesPlugin.optionsPage = 3;
            }
            if (Input.GetKeyDown(KeyCode.Alpha5) || Input.GetKeyDown(KeyCode.Keypad5))
            {
                RevolutionaryHostRolesPlugin.optionsPage = 4;
            }
            if (Input.GetKeyDown(KeyCode.Alpha6) || Input.GetKeyDown(KeyCode.Keypad6))
            {
                RevolutionaryHostRolesPlugin.optionsPage = 5;
            }
            if (page != RevolutionaryHostRolesPlugin.optionsPage)
            {
